...
/**
 * TCP PeerClient to make requests
...
public class SocketClient implements Runnable {
    ...
    /**
     *
     * @param outboundIP IPAddress of Server1 of DHT
     * @param port Port of Server1 of DHT
     * @param filename File name to be queried for download
     */
    ...
    private void receiveFile(long size, InputStream is, OutputStream os) throws IOException {
        try {
            ...
            File fileR = new File(path + "pictures" + File.separator + "received" + this.filename);
